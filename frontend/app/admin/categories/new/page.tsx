    ...
    <ProtectedRoute>
        ...
        <main className="admin-main">
          <header className="admin-header">
            <div>
              ...
              <h1 className="admin-header-title">Add New Category</h1>
            </div>
            <a href="/admin/categories" className="btn-back">← Back to Categories</a>
          </header>
          <CategoryForm />
        </main>
      </div>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .admin-form-card { background: var(--white); border: 1px solid var(--sand); border-radius: var(--radius); padding: 2rem 2.5rem; max-width: 480px; box-shadow: 0 2px 8px rgba(40,32,28,.05); }
        ...
        .field-input { width: 100%; padding: .78rem 1rem; border: 1.5px solid var(--sand); border-radius: 10px; font-size: .9rem; color: var(--ink); background: rgba(249,244,239,.6); outline: none; transition: border-color .2s, box-shadow .2s; font-family: var(--sans); font-weight: 300; }
        .field-input:focus { border-color: var(--rose); box-shadow: 0 0 0 3px rgba(196,151,138,.15); background: #fff; }
